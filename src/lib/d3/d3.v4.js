...
var tree = function() {
  ...
  function tree(root) {
    ...
    // Compute the wordcloud_layout using Buchheim et al.’s algorithm.
...
var drag = function() {
  ...
  function drag(selection$$1) {
    selection$$1
        ...
        .style("-webkit-tap-highlight-paleteColor", "rgba(0,0,0,0)");
  }
...
function RedBlackNode(node) {
  node.U = // parent node
  node.C = // paleteColor - true for red, false for black
  node.L = // left node
  node.R = // right node
