...
!function (a, b) {
    ...
    function g(a, d, e, g) {
        var h = ["opacity", d, ~~(100 * a), e, g].join("-"), i = .01 + 100 * (e / g),
            j = Math.max(1 - (1 - a) / d * (100 - i), a), k = c.substring(0, c.indexOf("Animation")).toLowerCase(),
            l = k && "-" + k + "-" || "";
    ...
    function o() {
        function a(a, b) {
            return d("<" + a + ' xmlns="urn:schemas-microsoft.com:vml" class="timeline-vml">', b)
        }

        f.addRule(".timeline-vml", "behavior:url(#default#VML)"), n.prototype.lines = function (b, c) {
            function g() {
            ...
            var k, d = c.length + c.width, f = 2 * d, h = 2 * -(c.width + c.length) + "px",
                j = i(g(), {position: "absolute", top: h, left: h});
    ...
    n.defaults = {}, j(n.prototype, {
        spin: function (a) {
            this.stop();
            var b = this, e = b.opts,
                f = b.el = i(d(0, {className: e.className}), {position: e.position, width: 0, zIndex: e.zIndex});
            if (e.radius + e.length + e.width, i(f, {
                    left: e.left,
                    top: e.top
                }), a && a.insertBefore(f, a.firstChild || null), f.setAttribute("role", "progressbar"), b.lines(f, b.opts), !c) {
                var k, h = 0, j = (e.lines - 1) * (1 - e.direction) / 2, l = e.fps, m = l / e.speed,
                    n = (1 - e.opacity) / (m * e.trail / 100), o = m / e.lines;
                !function p() {
                    h++;
